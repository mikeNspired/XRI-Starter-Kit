...
namespace MikeNspired.XRIStarterKit
{
    ...
    /// Exerts an increasing force when the rigidbody is separate from the anchor position, but does not oscilate like a spring.
    /// </summary>
    public class TransformJoint : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        bool m_AutoConfigureConnectedAnchor = false;
        ...
        /// </summary>
        public Vector3 Anchor { get => m_Anchor; set { m_Anchor = value; } }
        ...
        /// </summary>
        public Vector3 ConnectedAnchor { get => m_ConnectedAnchor; set { m_ConnectedAnchor = value; } }
        ...
        /// </summary>
        public bool AdjustMass { get => m_AdjustMass; set { m_AdjustMass = value; } }

        /// <summary>
        /// Baseline force applied when an obstacle is between the joint and the connected transform.
        /// </summary>
        public float BaseForce { get => m_BaseForce; set { m_BaseForce = value; } }

        /// <summary>
        /// Additional force applied based on the distance between joint and connected transform
        /// </summary>
        public float SpringForce { get => m_SpringForce; set { m_SpringForce = value; } }

        /// <summary>
        /// The distance this joint must be from the anchor before teleporting.
        /// </summary>
        public float BreakDistance { get => m_BreakDistance; set { m_BreakDistance = value; } }

        /// <summary>
        /// The angular distance this joint must be from the anchor before teleporting.
        /// </summary>
        public float BreakAngle { get => m_BreakAngle; set { m_BreakAngle = value; } }

        /// <summary>
        /// The angular distance this joint must be from the anchor before teleporting.
        /// </summary>
        public bool MatchRotation { get => m_MatchRotation; set { m_MatchRotation = value; } }
        ...
        bool m_FixedSyncFrame = false;
        bool m_ActiveCollision = false;
        bool m_CollisionFrame = false;
        bool m_LastCollisionFrame = false;
        ...
        float m_BaseMass = 1.0f;
        float m_AppliedForce = 0.0f;
        float m_OldForce = 0.0f;
        ...
        void FixedUpdate()
        {
            ...
            if (m_AdjustMass)
            {
                ...
                var massScale = Mathf.Max((offset / k_MaxForceDistance), 1.0f);
        ...
        {
            // Assume transform is synced to the rigid body position from late update
            // Convert anchor rotationss to world space
            ...
            if (angleOffset > Mathf.Epsilon)
            {
                ...
                {
                    var force = ((angleInDegrees / 360.0f) * (m_BaseForce + m_SpringForce));
