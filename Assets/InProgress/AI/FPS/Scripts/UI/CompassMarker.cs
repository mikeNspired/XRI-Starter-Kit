...
public class CompassMarker : MonoBehaviour
{
    ...
    public void Initialize(CompassElement compassElement, string textDirection)
    {
        ...
        {
            mRobotEnemyController = compassElement.transform.GetComponent<RobotEnemyController>();

            if (mRobotEnemyController)
            {
                mRobotEnemyController.onDetectedTarget += DetectTarget;
                mRobotEnemyController.onLostTarget += LostTarget;
