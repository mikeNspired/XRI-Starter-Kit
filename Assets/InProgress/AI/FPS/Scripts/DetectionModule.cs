...
public class DetectionModule : MonoBehaviour
{
        ...
        foreach (Actor otherActor in m_ActorsManager.actors)
        {
            if (otherActor.affiliation != affiliation)
            {
                ...
                if (sqrDistance < sqrDetectionRange && sqrDistance < closestSqrDistance)
                {
                    ...
                    // Debug.DrawRay(detectionSourcePoint.position, (otherActor.aimPoint.position - detectionSourcePoint.position).normalized * detectionRange);
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Gizmos.DrawWireSphere(detectionSourcePoint.transform.position, detectionRange);
    }
}