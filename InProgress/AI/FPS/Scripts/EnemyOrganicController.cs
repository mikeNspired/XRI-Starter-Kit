...
// public class EnemyNavOrganicController : A_EnemyNavController
// {
...
public class BodyFlashOnHit : MonoBehaviour
{
...
public class A_EnemyNavController : MonoBehaviour
{
