...
public class EnemySpawnerOverTime : MonoBehaviour
{
    ...
    private void InstantiateEnemy(GameObject enemyType, Vector3 pos)
    {
        ...
        if (enemy.GetComponent<A_EnemyNavController>())
            enemy.GetComponent<A_EnemyNavController>().SetNewPath(enemyPath);
        ...
        enemy.GetComponent<A_EnemyNavController>().onDeath += EnemyKilled;
    }
